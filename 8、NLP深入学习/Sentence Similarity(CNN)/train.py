...
import data_helpers
from Sentence_Similarity_CNN_Model import TextCNN
...
# Load data
print("Loading data...")
s1 ,s2, score = data_helpers.read_data_sets(FLAGS.data_file)
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        # Generate batches
        STS_train = data_helpers.dataset(s1=s1_train, s2=s2_train, label=score_train)
